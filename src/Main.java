...
public class Main {
    ...
    public static int[] heroesHealth = {1000, 950, 900, 1000, 4000, 1400, };
    public static int[] heroesDamage = {80, 60, 65, 0, 15, 85};
    public static String[] heroesAttackType = {"Physical", "Magical", "Kinetic", "Medic", "Golem", "Lacky", "Thor"};
        ...
        for (int i = 0; i < heroesHealth.length; i++) {
            if (chance && heroesHealth[5] > 0) {
               heroesHealth[5] += bossDamage;
                System.out.println("Лаки получил шанс");
                break;
            }
        }
    ...
    public static void chooseBossDefence() {
        Random random = new Random();
        int randIndex = random.nextInt(heroesAttackType.length); // 2, 3, 4, 5, 6, 7, 8, 9
